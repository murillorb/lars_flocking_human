...
private:
	...
	Competitions::Competition _fieldType;
...
private:
	...
	void updateDefaultFieldDimensions(const Competitions::Competition &fieldType);
...
public:
	GLSoccerView(const Competitions::Competition &fieldType, QWidget *parent = 0);
