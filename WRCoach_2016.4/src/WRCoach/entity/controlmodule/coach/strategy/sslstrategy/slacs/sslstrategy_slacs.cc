...
#include "sslstrategy_slacs.hh"
#include "sslstrategy_slacs_states.hh"

QString SSLStrategy_Slacs::name() {
    return "SSLStrategy_Slacs";
}

SSLStrategy_Slacs::SSLStrategy_Slacs() {

}

void SSLStrategy_Slacs::configure() {
...
//    setStrategyState(GAMEON, new SSLStrategy_WR2015_GameOn());
    setStrategyState(GAMEON, new SSLStrategy_Slacs_GameOn());
